    ...
    function transformRoot(node) {
        ...
        return function () {
            ...
            if (node.children.length !== 1) {
                error("the template requires one root node, detected ".concat(node.children.length, ". \n            The DdBind parser will only parse the first one"), null);
                return;
            }
            node.jsNode = {
    ...
    ***************************************************************************** */
    ...
    var DdBind = /** @class */ (function () {
        ...
        DdBind.prototype._bind = function () {
            var setups = this.$options.setup ? this.$options.setup.bind(this)() : {}; // 为setup绑定当前执行环境
            var methods = this.$options.methods ? this.$options.methods : {};
            ...
            // 绑定计算属性
            var computedList = this.$options.computed ? this.$options.computed : {};
            ...
            // 绑定侦听属性
            var watchesFn = this.$options.watch ? this.$options.watch : {};
