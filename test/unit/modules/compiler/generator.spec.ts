...
describe('generator', () => {
    ...
    // 测试if指令代码生成
    it ('generate d-if directive code', () => {
    ...
    // 测试show指令代码生成
    it ('generate d-show directive code', () => {
    ...
    // 测试bind指令代码生成
    it ('generate d-bind directive code', () => {
    ...
    // 测试on指令代码生成
    it ('generate d-on directive code', () => {
